...
const songRequest = __importStar(require("./song-request"));
const music = __importStar(require("./music"));
const osuMap = __importStar(require("./osu-map"));
const manageGems = __importStar(require("./manage-gems"));
...
exports.commands.set(songRequest.data.name, songRequest);
exports.commands.set(music.data.name, music);
exports.commands.set(osuMap.data.name, osuMap);
exports.commands.set(manageGems.data.name, manageGems);
