...
exports.generateHelpImage = generateHelpImage;
...
async function generateHelpImage() {
    ...
    (0, candyUtils_1.drawSprinkles)(ctx, width, height, 180);
    // Decorative Candies
    (0, candyUtils_1.drawLollipop)(ctx, 80, 100, 50);
    (0, candyUtils_1.drawLollipop)(ctx, 920, 1500, 60);
    (0, candyUtils_1.drawWrappedCandy)(ctx, 120, 1450, 70, '#FF8C00');
    (0, candyUtils_1.drawWrappedCandy)(ctx, 880, 120, 70, '#00CED1');
    (0, candyUtils_1.drawSparkle)(ctx, 500, 80, 20);
    // --- Header ---
    ctx.save();
    ...
    categories.forEach((cat, index) => {
        ...
        (0, candyUtils_1.drawCandyGlassCard)(ctx, boxX, currentY, boxW, boxH, 45);
        // Header Strip
        ctx.save();
        ctx.beginPath();
        ...
        // Sparkle near title
        (0, candyUtils_1.drawSparkle)(ctx, boxX + boxW - 60, currentY + 45, 12);
        // Commands
