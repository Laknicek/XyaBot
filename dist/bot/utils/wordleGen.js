...
exports.generateWordleBoard = generateWordleBoard;
const canvas_1 = require("canvas");
const candyUtils_1 = require("./candyUtils");
function generateWordleBoard(word, guesses) {
    const width = 700;
    const height = 900;
    ...
    (0, candyUtils_1.drawSprinkles)(ctx, width, height, 100);
    // Decorations
    (0, candyUtils_1.drawLollipop)(ctx, 60, 60, 45);
    (0, candyUtils_1.drawWrappedCandy)(ctx, 640, 60, 60, '#FF1493');
    (0, candyUtils_1.drawWrappedCandy)(ctx, 60, 840, 60, '#00CED1');
    (0, candyUtils_1.drawLollipop)(ctx, 640, 840, 45);
    // Title
    ctx.save();
    ...
    const startY = 140;
    // Board Glass Card
    (0, candyUtils_1.drawCandyGlassCard)(ctx, startX - 40, startY - 40, totalW + 80, totalH + 80, 50);
    ...
    // Sparkles on board
    (0, candyUtils_1.drawSparkle)(ctx, startX - 20, startY - 20, 15);
    (0, candyUtils_1.drawSparkle)(ctx, startX + totalW + 20, startY + totalH + 20, 15);
