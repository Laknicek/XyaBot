...
exports.drawCandyBackground = drawCandyBackground;
exports.drawSprinkles = drawSprinkles;
exports.drawLollipop = drawLollipop;
exports.drawWrappedCandy = drawWrappedCandy;
exports.drawSparkle = drawSparkle;
exports.drawCandyGlassCard = drawCandyGlassCard;
function drawCandyBackground(ctx, width, height) {
...
function drawSprinkles(ctx, width, height, count = 100) {
...
function drawLollipop(ctx, x, y, size) {
    ctx.save();
    // Stick
...
function drawWrappedCandy(ctx, x, y, width, color) {
    ctx.save();
    ctx.translate(x, y);
...
function drawCandyGlassCard(ctx, x, y, w, h, radius) {
    ctx.save();
    // Glass Body
