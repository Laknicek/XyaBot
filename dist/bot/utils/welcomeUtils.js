...
exports.getAestheticWelcomeMessage = getAestheticWelcomeMessage;
exports.getAestheticDM = getAestheticDM;
function getAestheticWelcomeMessage(userId) {
...
function getAestheticDM(guildName) {
    return `
