...
export type ToxicityCategory = "Rude" | "Hateful" | "Racist" | "Neutral";

interface BadWordPattern {
    pattern: RegExp;
    category: ToxicityCategory;
}

const patterns: BadWordPattern[] = [
 ...
 */
export function checkToxicity(content: string): ToxicityCategory {
    ...
    const normalizedPatterns: {regex: RegExp, category: ToxicityCategory}[] = [
